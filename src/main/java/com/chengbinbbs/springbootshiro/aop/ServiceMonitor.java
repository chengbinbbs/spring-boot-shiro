package com.chengbinbbs.springbootshiro.aop;
...
public class ServiceMonitor {
    ...
    @Before("execution(* com.chengbinbbs.springbootshiro.controller.*.*(..))")
    public void countServiceInvoke(JoinPoint joinPoint) {
        counterService.increment(joinPoint.getSignature() + "");
    }

    @Around("execution(* com.chengbinbbs.springbootshiro.controller.*.*(..))")
